...
Страница аутентификации через сервисы
http://127.0.0.1:8000/
Профиль
...
TODO понять почему в некоторых случаях при наличии админа среди пользователей, заход через GitHub приводит к авторизации админа, а не пользователя